...
- **LoRa APRS KISS client over bluetooth** (WiFi is not used in this configuration), specificed in configuration
...
- **LoRa APRS iGate RX/TX server over WiFi + Digipeater**, could be also used as a client simultaneously, e.g. when stationary for non-AX.25 DV audio
